...
class LoginCartViewController: UIViewController {
 ...
 //  var loginSuccessed: ((Bool?)->())?
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if UserService.shared.getToken() != "" {
            ...
            let doneLoginVC = sb.instantiateViewController(withIdentifier: "DoneLoginCartViewController") as! DoneLoginCartViewController
            self.navigationController?.pushViewController(doneLoginVC, animated: true)
        }
    }
    ...
    @IBAction func didTapCreateANewAcc(_ sender: UIButton) {
        registerButton.isEnabled = true
        let sb = UIStoryboard(name: "Main", bundle: nil)
        let createAccount = sb.instantiateViewController(identifier: "RegisterCartViewController") as! RegisterCartViewController
...
extension LoginCartViewController {
        ...
        APIService.postLogin(with: emailTextField.text ?? "", and: passwordTextField.text ?? "") { accountUser, error in
            ...
            DispatchQueue.main.async {
                ...
                if self.checkLogin == true {
                    let sb = UIStoryboard(name: "Main", bundle: nil)
                    let doneLoginVC = sb.instantiateViewController(withIdentifier: "CartViewController") as! CartViewController
                    self.navigationController?.pushViewController(doneLoginVC, animated: true)
